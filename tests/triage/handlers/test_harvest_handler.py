...
class TestHarvestHandler:
    ...
    def test_adds_tag_on_profit_target(self, handler):
        ...
        request = TriageRequest(
            ...
            strategy_delta=0, strategy_gamma=0, pl_pct=0.55,
            ...
            net_liquidity=50000, strategy_obj=strategy_obj
        )
    ...
    def test_skips_debit_positions(self, handler):
        request = TriageRequest(
            root="AAPL", strategy_name="Long Call", strategy_id="lc",
            dte=30, net_pl=100.0, net_cost=500.0,  # Debit
            strategy_delta=0, strategy_gamma=0, pl_pct=0.20,
            days_held=10, price=150.0, legs=(),
            vrp_structural=1.0, vrp_tactical=1.0, is_stale=False,
            sector="Tech", earnings_date=None, portfolio_beta_delta=0,
