...
from variance.triage.handlers.slow_theta import SlowThetaHandler
from variance.triage.handlers.toxic_theta import ToxicThetaHandler
from variance.triage.handlers.wild_pl import WildPlHandler
...
class TriageChain:
    ...
    def _build_chain(self) -> None:
        ...
        handlers = [
            ...
            # Informational warnings (low priority)
            SlowThetaHandler(self.rules),
            WildPlHandler(self.rules),
        ]
